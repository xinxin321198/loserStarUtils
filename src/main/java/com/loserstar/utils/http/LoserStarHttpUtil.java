...
public class LoserStarHttpUtil {
    static {
        // 设置HTTP和HTTPS的最大并发连接数
        System.setProperty("http.maxConnections", "10000");
        System.setProperty("https.maxConnections", "10000");
    }
    ...
    /**
     * 创建一个http的请求连接对象，可以设置超时时间（根据协议决定是创建http还是https,https是所有证书都信任的） 默认6万毫秒=1分钟的连接时间吧，否则通常忘记设置这个时间，就超时了
     *
     * @param urlStr url地址
    ...
    public static HttpURLConnection createHttpUrlConnection(String urlStr, String method) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException {
        return createHttpUrlConnection(urlStr, method, 60000);
    }
     ...
     * @throws KeyManagementException
     */
    public static HttpURLConnection createHttpUrlConnection(String urlStr, String method, int timeout) throws IOException, NoSuchAlgorithmException, KeyManagementException {
     ...
     *
     * @param urlStr           请求的url
     * @param requestHeaderMap 请求头的信息 Content-Type参考：https://www.runoob.com/http/http-content-type.html https://www.cnblogs.com/wangyuxing/p/10037470.html
     *                         <p>
